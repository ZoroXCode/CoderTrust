...
function Page() {
  return (
    <section className="h-screen text-primary body-font">
      <div className="container px-5 py-24 mx-auto h-full">
        <div className="flex flex-col text-center w-full mb-20">
          <h1 className="text-2xl font-medium title-font mb-4 text-primary tracking-widest font-mono underline">
            OUR TEAM
          </h1>
            ...
            <div key={index} className="p-4 lg:w-1/2">
              <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                ...
                <div className="flex-grow sm:pl-8">
                  <h2 className="title-font font-medium text-lg text-primary font-mono underline-offset-2">
                    {member.name}
                  </h2>
                  <h3 className="text-primary mb-3 underline">{member.role}</h3>
