  ...
  return (
    <section className="container px-4 py-10 mx-auto min-h-screen flex flex-col lg:flex-row lg:space-x-8 lg:items-center">
      ...
      <div className="w-full lg:w-1/2 text-center lg:text-left">
        <h1 className="text-3xl sm:text-4xl font-bold mb-6 tracking-tight mt-12">
          CoderTrust
        </h1>
        <p className="text-base sm:text-lg leading-relaxed">
          Welcome to our organization! We are dedicated to delivering innovative
          solutions and fostering meaningful relationships with our community.
          Through passion, perseverance, and teamwork, we strive to make a
          positive impact.
        </p>
      </div>
